    ...
    <div className="flex items-center gap-1">
        ...
        <>
          ...
          {mission.status === 'active' && (
            <Button
              ...
              className="h-8 w-8 p-0 text-orange-600 hover:text-orange-700 hover:bg-orange-50 border-orange-200 hover:border-orange-300"
            >
      ...
      {canDeleteTrips && (
        <Button
          ...
          className="h-8 w-8 p-0 text-red-500 hover:text-red-600 hover:bg-red-50 border-red-200 hover:border-red-300"
        >
